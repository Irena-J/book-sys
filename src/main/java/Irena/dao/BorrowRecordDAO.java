...
public class BorrowRecordDAO {
    ...
    public static List<BorrowRecord> query() {
        ...
        try {
            ...
            // sql 字符串进行数据库操作，基于这个sql创建下面这个对象
            ...
            throw new SystemException("00001","查询图书借阅信息出错");
        } finally {
    ...
    public static BorrowRecord queryById(int id) {
        ...
        try {
            ...
            throw new SystemException("00006","查询图书借阅详情信息出错");
        } finally {
            DBUtil.close(c,ps,rs);
        }
    ...
    public static int update(BorrowRecord record) {
        ...
        try {
            ...
            throw new SystemException("000010","修改图书借阅信息出错");
        } finally {
            DBUtil.close(c,ps);
        }
    }
    ...
    public static int insert(BorrowRecord record) {
        ...
        try {
            ...
            throw new SystemException("000009","添加图书借阅信息出错");
        } finally {
            DBUtil.close(c,ps);
        }
    }
    ...
    public static int delete(String[] ids) {
        ...
        try {
            ...
            throw new SystemException("000012","删除图书借阅信息出错");
        } finally {
            DBUtil.close(c,ps);
        }
    }
